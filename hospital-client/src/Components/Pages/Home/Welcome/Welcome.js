...
const Welcome = () => {
  return (
    <div className="py-5 px-24 bg-white mt-2">
      ...
      <div className="grid grid-cols-12 gap-10">
        ...
        <div className="col-span-7 font-meStyle text-lg -mt-7">
          <p>
            ...
            successive generations of Smart Health Care people, who have made it
            their mission to give back to the society more than what it draws
